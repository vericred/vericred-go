 ...
 */
func (a ZipCountiesApi) GetZipCounties(zipPrefix string) (*ZipCountiesResponse, *APIResponse, error) {
	...
	var successPayload = new(ZipCountiesResponse)
 ...
 */
func (a ZipCountiesApi) ShowZipCounty(id int32) (*ZipCountyResponse, *APIResponse, error) {

	var localVarHttpMethod = "Get"
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/zip_counties/{id}"
