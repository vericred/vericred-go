...
func (a DrugPackagesApi) ShowFormularyDrugPackageCoverage(formularyId string, ndcPackageCode string) (*FormularyDrugPackageResponse, *APIResponse, error) {
	...
	localVarPath := a.Configuration.BasePath + "/formularies/{formulary_id}/drug_packages/{ndc_package_code}"
	localVarPath = strings.Replace(localVarPath, "{"+"formulary_id"+"}", fmt.Sprintf("%v", formularyId), -1)
	...
	var successPayload = new(FormularyDrugPackageResponse)
