...
func (a NetworkSizesApi) ListStateNetworkSizes(stateId string, page int32, perPage int32) (*StateNetworkSizeResponse, *APIResponse, error) {
	...
	localVarPath := a.Configuration.BasePath + "/states/{state_id}/network_sizes"
	...
	var successPayload = new(StateNetworkSizeResponse)
 ...
 * @return *StateNetworkSizeResponse
 */
func (a NetworkSizesApi) SearchNetworkSizes(body StateNetworkSizeRequest) (*StateNetworkSizeResponse, *APIResponse, error) {

	var localVarHttpMethod = "Post"
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/network_sizes/search"
