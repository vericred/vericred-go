...
**Age29Rider** | **bool** | True if the plan allows dependents up to age 29 | [optional] [default to null]
...
**DisplayName** | **string** | Alternate name for the Plan | [optional] [default to null]
**DpRider** | **bool** | True if plan does not cover domestic partners | [optional] [default to null]
...
**FpRider** | **bool** | True if plan does not cover family planning | [optional] [default to null]
...
**HsaEligible** | **bool** | Is the plan HSA eligible? | [optional] [default to null]
...
**PlanType** | **string** | Category of the plan (e.g. EPO, HMO, PPO, POS, Indemnity, PACE, Medicare-Medicaid, HMO w/POS, Cost, FFS, MSA) | [optional] [default to null]
...
**Source** | **string** | Source of the plan benefit data | [optional] [default to null]
